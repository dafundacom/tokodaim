...
interface DashboardEditItemProps extends React.HTMLAttributes<HTMLDivElement> {
  item: Partial<SelectItem>
  priceLists: SelectDigiflazzPriceList[]
  updateItems: (_data: SelectedItemsProps[]) => void
}

const DashboardEditItem: React.FunctionComponent<DashboardEditItemProps> = (
  props,
) => {
  const { item, priceLists, updateItems } = props
