                    ...
                    <div className="mt-8 text-sm font-medium">
                      <div className="grid grid-cols-3 gap-4 pb-2">
                        ...
                        <div className="col-span-2">
                          <p className="break-words">{orderData?.accountId}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="mt-8 grid w-full grid-cols-8 gap-4 border-t pt-8 text-left md:gap-x-2">
                      ...
                      <div className="col-span-5 md:col-span-4">
                        <Button
                          ...
                          onClick={() =>
                            copyToClipboard(orderData?.invoiceId ?? "")
                          }
                          type="button"
              ...
              <div>
                <dl className="space-y-6 py-6 text-sm">
                  <div className="flex justify-between">
                    ...
                    <dd>
                      {changePriceToIDR(
                        tripayTransactionData?.amount - (orderData?.fee ?? 0),
                      )}
                    </dd>
                  </div>
                  <div className="flex justify-between">
                    <dt className="font-medium">Fee</dt>
                    <dd>{changePriceToIDR(orderData?.fee ?? 0)}</dd>
                  </div>
